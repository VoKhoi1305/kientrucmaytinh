...
jal GO 
nop 
sleep11: addi $v0,$zero,32 # Keep running by sleeping in 4000 ms 
li $a0,4000  
syscall 
...
jal GO 
nop 
sleep12: addi $v0,$zero,32 # Keep running by sleeping in 4000 ms 
li $a0,4000  
syscall
...
goASKEW:addi $a0, $zero, 307 # Marsbot rotates 307
 jal ROTATE 
 nop
 jal UNTRACK # keep old track
 nop
...
sleep4: addi $v0,$zero,32 # Keep running by sleeping in 2000 ms 
 ...
 addi $a0, $zero, 90 # Marsbot rotates 90* , go out of triangle to see  
 jal ROTATE 
 nop
 jal UNTRACK # keep old track
 nop 
